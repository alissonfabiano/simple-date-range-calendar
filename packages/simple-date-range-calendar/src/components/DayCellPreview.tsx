...
const DayCellPreview = styled('div')<DayCellPreviewProps>(
  ({
    theme,
    isToday,
    isInPreviewingRange,
    ...
    const rangeStartBorderColor = direction === 'left'
