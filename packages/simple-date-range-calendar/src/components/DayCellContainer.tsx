import { styled, Theme, ThemeOptions } from "@mui/material";
...
const DayCellContainer = styled("div")<DayCellContainerProps>(
  ({
    theme,
    isToday,
    direction,
    ...
    return {
      ...
      ":first-of-type": {
        ...
        "> div": {
          ...
          borderBottomLeftRadius: "50%",
          borderLeftColor:
            isInPreviewingRange && !isInRange
              ? theme.palette.border.previewing
              : "transparent",
        },
      },
      ":last-of-type": {
        ...
        "> div": {
          ...(isInPreviewingRange &&
            !isInRange && {
              ...
              borderRadius:
                direction === "right" ? "0px 50% 50% 0px" : "50% 0px 0px 50%",
            }),
          ...(isInRange &&
            isRangeStart && {
              borderColor: "transparent",
              borderRadius:
                direction === "left" ? "0px 50% 50% 0px" : "50% 0px 0px 50%",
            }),
          ...(isInRange &&
            isRangeEnd && {
              borderColor: "transparent",
